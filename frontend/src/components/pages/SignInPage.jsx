    ...
    <main className="grid min-h-screen grid-cols-[minmax(0,0.95fr)_minmax(420px,1.05fr)] bg-slate-50 max-[900px]:grid-cols-1">
      ...
      <section className="flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-[420px] rounded-xl border border-slate-200 bg-white p-7 shadow-sm">
          ...
          <form className="mt-7 grid gap-4" onSubmit={handleSignIn}>
            ...
            <button
              className="mt-2 flex items-center justify-center rounded-md border-0 bg-blue-700 px-4 py-3 text-sm font-bold text-white hover:bg-blue-800 disabled:opacity-70"
              type="submit"
